...
public class TestRejectTimeTrack extends BaseClass{
    ...
    public void clickRejectBtn(){
        ApproveTimeTrackPage objApproveTimeTrack;
        objApproveTimeTrack = new ApproveTimeTrackPage(driver);
        objApproveTimeTrack.clickReject();
    }
    
    @Test(priority=5)
    public void enterRejectReason(){
        ApproveTimeTrackPage objApproveTimeTrack;
        objApproveTimeTrack = new ApproveTimeTrackPage(driver);
        objApproveTimeTrack.setRejectReason("Reject Timesheet");
    }
    
    @Test(priority=6)
    public void clickReasonRejectBtn(){
        ApproveTimeTrackPage objApproveTimeTrack;
        objApproveTimeTrack = new ApproveTimeTrackPage(driver);
        objApproveTimeTrack.clickReasonReject();
    }
